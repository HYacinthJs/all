<template>
    <div class="book">
        <v-touch @swipeleft="swiperleft" @swiperight="swiperright">
            ...
            <div id="read"></div>
            <MenuBar ref="menuBar" :show="show" :fontSizeList="fontSizeList" :defaultFontSize="defaultFontSize"
                :themeList="themeList" :defaultTheme="defaultTheme" @setFontSize="setFontSize" @fontUp="fontUp"
                @fontLow="fontLow" @setTheme="setTheme" :bookAvailable="bookAvailable"
                @onProgressChange="onProgressChange" :navigation="navigation" @jumpTo="jumpTo"></MenuBar>
        </v-touch>
...
export default {
    ...
    data() {
        return {
            ...
            //   字体大小列表
            fontSizeList: [
                { fontSize: 12, }, { fontSize: 14, }, { fontSize: 16, }, { fontSize: 18, }, { fontSize: 20, }, { fontSize: 22, }, { fontSize: 24, },
            ],
            //   默认字体大小
            defaultFontSize: 16,
