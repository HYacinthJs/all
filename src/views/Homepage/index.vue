<template>
    <section>
        ...
        <el-scrollbar ref="scrollbar" height="400px" always class="scrollbar">
            <div class="img">
                <el-image style="width: 100%; height: 130px" :src="this.$store.state.backgroundImage" :fit="'fill'">
                </el-image>
                <el-upload class="avatar-uploader" :action="`${$base}api/user/uploadBackgroundImage`" :data="fileData"
                ...
                <div class="content">
                    <div class="block">
                        <el-image style="width: 65px; height: 65px;border-radius: 50%" :src="srcList[0]"
                            :preview-src-list="srcList"></el-image>
                    </div>
                    <el-button plain size="small" class="button1" @click="$router.push('/editInformation')">编辑资料
                    </el-button>
                    <div class="content-bottom">
                        ...
                        <div class="information"
                            v-if="$store.state.introduction === 'null' || $store.state.introduction.length === 0">
                            暂无描述！！！！！
                        </div>
                ...
                <div class="release">
                    ...
                    <div class="content_none" v-if="articles.length > 0">
                        ...
                        <el-pagination class="mpage" background layout="prev, pager, next" :current-page=currentPage
                            :page-size=pageSize @current-change=page :total="total">
                        </el-pagination>
                    </div>
