  ...
  <div id="Logs">
    ...
    <el-card class="box-card">
          ...
          <el-table-column label="操作">
            <template slot-scope="scope">
              ...
              <el-tooltip effect="dark" content="下架视频" placement="top-start" :enterable="false">
                <el-button type="danger" icon="el-icon-delete" size="mini" @click="deleteMedia(scope.row.fileId)">
                </el-button>
              </el-tooltip>
            </template>
          </el-table-column>
      ...
      <el-pagination style="margin-top:10px;" background @size-change="handleSizeChange"
        @current-change="handleCurrentChange" :current-page="this.mediaPage.pageNo" :page-sizes="[3, 5, 8, 10]"
        :page-size="this.mediaPage.pageSize" layout="total, sizes, prev, pager, next, jumper" :total="total">
      </el-pagination>
    </el-card>
  </div>
</template>
