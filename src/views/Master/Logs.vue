  ...
  <div id="Logs">
    ...
    <el-card class="box-card">
      ...
      <el-pagination style="margin-top:10px;" background @size-change="handleSizeChange"
        @current-change="handleCurrentChange" :current-page="this.logPage.pageNum" :page-sizes="[5, 10, 15, 20]"
        :page-size="this.logPage.pageSize" layout="total, sizes, prev, pager, next, jumper" :total="total">
      </el-pagination>
    </el-card>
  </div>
</template>
