  ...
  <el-container class="home-container">
    ...
    <el-container>
      ...
      <el-aside :width="isCollapse ? '50px' : '200px'">
        ...
        <el-menu :default-active="activePath" active-text-color="#409eff" background-color="#2b8eff" unique-opened
          text-color="white" :collapse="isCollapse" :router="true" :collapse-transition="false">
