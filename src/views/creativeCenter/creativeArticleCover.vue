<template>
    ...
    <div>
        ...
        <van-panel :title="'文章标题：' + headLine" :desc="'作者：' + userName">
            ...
            <template #footer>
                <van-button size="normal" type="info" icon="success" round style="margin-left:30%; margin-top: 12%"
                    @click="submitArticle">发布</van-button>
        ...
        <div class="upload-wrapper" v-show="radio == '单图'">
            <el-upload :action="actionUrl" list-type="picture-card" :limit="1" :on-success="uploadSuccess"
...
export default {
    ...
    mounted() {
        ...
        this.actionUrl = `${this.$base}home/articleCover/upload`;
    },
    methods: {
        async submitArticle() {
            if (this.radio === '无图') {
