<template>
    <div>
        ...
        <div class="hongbao">
            ...
            <div class="list-invite-txt" v-show="!((invitelist.length % 3) === 0)">你还差 <span
                    style="color: red;font-size: 20px;">{{ 3 - (invitelist.length % 3) }}</span>位好友就可以参与抽奖!!!</div>

            <el-button v-show="((invitelist.length % 3) === 0)" type="danger" round @click="qhongbao()" class="btn-inv-txt">
                抢红包!!!</el-button>
    ...
    data() {
        return {
            ...
            options: [[
                ...
                { name: 'qq空间', icon: '~@/assets/images/chahao.jpg', description: 'qZone', className: 'qZone-c' },
