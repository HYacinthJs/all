<template>
    <div>
        <van-sticky>
            <van-nav-bar :title="city" right-text="更换城市" left-arrow @click-left="returnBack"
                @click-right="onClickRight" />
        </van-sticky>
        <div style="position: relative">
            <el-card class="box-card" shadow="hover" :body-style="{ backgroundColor: '#F3F3F3' }">
                <img v-if="weather[1].weather.indexOf('阴') !== -1" src="../../assets/images/weather/top/阴.jpg"
                    style="height: 100px;width: 100px;margin-left: 10%">
                <img v-else-if="weather[1].weather.indexOf('雨') !== -1" src="../../assets/images/weather/top/雨.jpg"
                    style="height: 100px;width: 100px;margin-left: 10%">
                <img v-else-if="weather[1].weather.indexOf('云') !== -1" src="../../assets/images/weather/top/多云2.jpg"
                    style="height: 100px;width: 100px;margin-left: 10%">
                <img v-else-if="weather[1].weather.indexOf('晴') !== -1" src="../../assets/images/weather/top/晴.jpg"
                    style="height: 100px;width: 100px;margin-left: 10%">
        ...
        <div style="position: relative">
            <el-card class="box-card" shadow="hover" :body-style="{ backgroundColor: '#F3F3F3' }">
                <img v-if="weather[2].weather.indexOf('阴') !== -1" src="../../assets/images/weather/top/阴.jpg"
                    style="height: 100px;width: 100px;margin-left: 10%">
                <img v-else-if="weather[2].weather.indexOf('雨') !== -1" src="../../assets/images/weather/top/雨.jpg"
                    style="height: 100px;width: 100px;margin-left: 10%">
                <img v-else-if="weather[2].weather.indexOf('云') !== -1" src="../../assets/images/weather/top/多云2.jpg"
                    style="height: 100px;width: 100px;margin-left: 10%">
                <img v-else-if="weather[2].weather.indexOf('晴') !== -1" src="../../assets/images/weather/top/晴.jpg"
                    style="height: 100px;width: 100px;margin-left: 10%">
        ...
        <el-card class="box-card">
            ...
            <div class="text item">
                <van-progress :percentage="weather[0].air[0] / 10" :pivot-text="weather[0].air[0]" pivot-color="#92C160"
                    color="#92C160" />
...
export default {
    ...
    created() {
        this.$axios.get(`${this.$base}api/getWeather`, {
            params: {
