...
export default {
    ...
    methods: {
        ...
        login() {
            ...
            this.$axios.post(`${this.$base}api/user/login`, {
                ...
                if (res.data.status === 200) {
                    ...
                    if (res.data.avatar === null) {
                        localStorage.setItem('avatar', "~@/assets/images/chahao.jpg");
                    } else {
                        localStorage.setItem('avatar', res.data.avatar);
                    }
                    if (res.data.backgroundImage === null) {
                        localStorage.setItem('backgroundImage', "~@/assets/images/chahao.jpg");
                    } else {
